...
<body>
    ...
    <div class="community_section">
        ...
        <div class="c_view_content" style="height: auto; border: 1px solid #ccc; border-radius: 5px; margin-bottom: 50px;">
                    ...
                    <div class="community_top">
                        ...
                        <div class="c_bbs_func">
                            ...
                            <button type="button">
                           	...
                           	<a href="community_update.do?wnum=${param.num}" class="button-link">
  							<button type="button" class="edit-button">
   								<i class="fas fa-edit"></i>
  							</button>
							</a>

							<a href="community_deleteOK.do?wnum=${param.num}" class="button-link">
